...
const user_rouer_1 = require("./user.rouer");
const authMiddleware = __importStar(require("../middlewares/auth.middleware"));
const mainV1Router = (app) => {
    const version = "/api/v1";
    app.use(version + "/tasks", authMiddleware.requireAuth, task_router_1.taskRouter);
    app.use(version + "/users", user_rouer_1.userRouter);
};
